\copy (select id,lettera,numero,o.name,o.d_objects_folder_id from bio_iconografico_cards b join d_objects o using(id) WHERE length(lettera)=1) to '/home/storage/preesistente/bct/bio_iconografico/sql_data/cards';
