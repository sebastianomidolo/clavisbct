# -*- encoding: utf-8 -*-
# stub: pdf-reader 2.4.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/yob/pdf-reader/issues", "changelog_uri" => "https://github.com/yob/pdf-reader/blob/v2.4.1/CHANGELOG", "documentation_uri" => "https://www.rubydoc.info/gems/pdf-reader/2.4.1", "source_code_uri" => "https://github.com/yob/pdf-reader/tree/v2.4.1" } if s.respond_to? :metadata=
